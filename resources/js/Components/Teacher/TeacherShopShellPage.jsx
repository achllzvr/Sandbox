...
export default function TeacherShopShellPage({ cert, catalogIndex = 0, onBack, onOpenEnroll }) {
    ...
    return (
        <div className={`student-shop-shell-page student-shop-shell-page--teacher student-shop-shell-page--${theme} student-fade-in-up`} style={themeStyle}>
            ...
            <section className="student-shop-shell-page__info" aria-labelledby="teacher-shop-shell-title">
                <h1 id="teacher-shop-shell-title" className="student-shop-shell-page__title">
            ...
            <div className="student-shop-shell-page__actions">
                <div className="student-shop-shell-page__cta-stack">
                    <button type="button" className="student-shop-btn student-shop-btn--primary teacher-shop-shell-page__batch-btn" onClick={onOpenEnroll}>
                        Enroll batch via vouchers
                    </button>
                </div>
