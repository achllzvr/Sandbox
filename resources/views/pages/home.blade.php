...
<section class="hero-section">
    <div class="container">
        ...
        <p class="hero-subtitle">The ultimate professional solution for admins, staff, and certification takers.</p>
    ...
    <div class="container">
        ...
        <div class="grid-3">
            <div class="card role-card">
                <h3>Admin</h3>
                <p>Full control over the system. Admins manage staff accounts, create new certifications, and oversee the entire learning platform.</p>
            </div>

            <div class="card role-card">
                <h3>Staff / Teacher</h3>
                <p>Appointed by admins. Staff members are responsible for uploading lessons, managing modules, and organizing examination materials.</p>
            </div>
